...
var TodoAction = require('../../actions/fluxibleTodo')
...
var TodoItem = React.createClass({
    ...
    handleToggle: function (evt) {
        this.context.executeAction(TodoAction.ToggleTodo, {
            id: this.props.id,
    ...
    handleBlur: function () {
        ...
        if (this.state.isEditing && text) {
            ...
            this.context.executeAction(TodoAction.UpdateTodo, {
                id: this.props.id,
                label: text
            })
        }
    ...
    handleDestroy: function () {
        ...
        this.context.executeAction(TodoAction.RemoveTodo, {
            id: this.props.id
        })
    },
    render: function () {
